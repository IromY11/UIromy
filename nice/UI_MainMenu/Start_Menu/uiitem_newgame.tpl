includeReference("world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/start_menu_pack_mainmenupacked.ilu")
params =
{
    NAME="Actor_Template",
    Actor_Template =
				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/newgame_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/newgame_Stand.anm",
							loop=1,
						},
					},							
					{
						...
						{
							friendlyName="Locked",
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/newgame_Locked.anm",
							loop=1,
						},
					},					
				},
