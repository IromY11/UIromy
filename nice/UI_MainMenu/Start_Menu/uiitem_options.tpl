				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Option_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Option_Stand.anm",
							loop=1,
						},
					},							
				},
