				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Clue_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Clue_Unselected.anm",
							loop=1,
						},
					},							
				},
