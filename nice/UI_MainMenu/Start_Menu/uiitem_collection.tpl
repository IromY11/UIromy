includeReference("world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/start_menu_pack_pausepacked.ilu")
params =
{
    NAME="Actor_Template",
    Actor_Template =
				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/collection_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/collection_Unselected.anm",
							loop=1,
						},
					},							
				},
