				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Legal_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Legal_Unselected.anm",
							loop=1,
						},
					},							
				},
