				...
				{
					{
						...
						{
							friendlyName="ON",
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/sound_on.anm",
							loop=1,
						},
					},
					{
						...
						{
							friendlyName="OFF",
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/sound_Of.anm",
							loop=1,
						},
					},							
				},
