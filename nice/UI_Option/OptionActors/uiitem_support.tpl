				...
				{
					{
						...
						{
							friendlyName="ON",
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Suport_Selected.anm",
							loop=1,
						},
					},
					{
						...
						{
							friendlyName="OFF",
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Suport_Unselected.anm",
							loop=1,
						},
					},							
				},
