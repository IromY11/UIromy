				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Social_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_WW1/common/hud/UI_VH/UI_Option/OptionActors/Animation/Social_Unselected.anm",
							loop=1,
						},
					},							
				},
