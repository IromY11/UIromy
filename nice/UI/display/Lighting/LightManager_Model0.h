...
#define _ITF_LIGHTMANAGER_MODEL0_H_
...
namespace ITF
{
	...
	class GFX_LightManager_Model0 : public GFX_LightManager_Base
	{
	public:

		///// constructor/destructor --------------------------------------------------------------
		GFX_LightManager_Model0(GFXAdapter *_adapter);
		~GFX_LightManager_Model0();
	...
	protected:
		...
		typedef GFX_LightManager_Model0 GFX_LightManager_Implementation;
	#endif
} // namespace ITF
