				...
				{
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Yellow_Square_Selected.anm",
							loop=1,
						},
					},
					{
						SubAnim_Template=
						{
							...
							name = "world/_ww1/common/hud/ui_mainmenu/start_menu/Animation/Yellow_Square.anm",
							loop=1,
						},
					},							
				},
