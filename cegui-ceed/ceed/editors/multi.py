...
from PySide.QtGui import QSyntaxHighlighter,QTabWidget, QTextEdit, QMessageBox, QWidget
...
class XMLHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        xmlElementFormat.setForeground(QtCore.Qt.darkBlue)
...
class CodeEditMode(QTextEdit, EditMode):
    ...
    def __init__(self):
        ...
        highlighter = XMLHighlighter(self.document())
